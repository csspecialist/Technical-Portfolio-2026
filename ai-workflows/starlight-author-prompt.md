...
1. **Frontmatter:** Every document must start with valid Astro Starlight YAML frontmatter containing at least `title`, `description` and `lang`.
   Example:
   ---
...
3. **Starlight Components (Crucial):**
...
**OUTPUT LANGUAGE:** [English / fr / fr-ca]
